module "rds_instance" {
  ...
  source                                       = "github.com/Modern-Logic/terraform-modules.git//simple/rds?ref=v1.14.4"
  ...
  use_custom_parameter_group_for_read_replicas = var.use_custom_parameter_group_for_read_replicas
}
